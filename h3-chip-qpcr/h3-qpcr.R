...
plot_qpcr = function(df, gene_id, norm="input"){
    ...
    plot = ggplot(data = subdf, aes(x=(amplicon_start+amplicon_end)/2, y=value,
        ...
        ylab("enrichment (AU)") +
        ggtitle(paste("H3 ChIP-qPCR at", gene_id),
...
ggsave('h3-chip-qpcr_spom-pma1-input-norm.svg', plot=pma, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_spom-act1-input-norm.svg', plot=act, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-vam6-input-norm.svg', plot=vam_input, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-vam6-spom-pma1-norm.svg', plot=vam_pma, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-vam6-spom-act1-norm.svg', plot=vam_act, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-hsp82-input-norm.svg', plot=hsp_input, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-hsp82-spom-pma1-norm.svg', plot=hsp_pma, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-hsp82-spom-act1-norm.svg', plot=hsp_act, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-pma1-input-norm.svg', plot=pma_input, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-pma1-spom-pma1-norm.svg', plot=pma_pma, width=16, height=10, units="cm")
ggsave('h3-chip-qpcr_scer-pma1-spom-act1-norm.svg', plot=pma_act, width=16, height=10, units="cm")
